...
SELECT * FROM resultados; #selecionar banco de dados com botão direito ou colocar nomedobanco.nomedatabela
...
SELECT * FROM resultados WHERE setor="Tecnologia"; #43 empresas no setor de tecnologia
SELECT * FROM resultados WHERE setor="Energia"; #57 empresas no setor de energia

#Setor de Energia possuem mais players