...
-- Atualizar o email da aluna Eliane.
...
#Informações e comandos para não esquecer:
	# 1. Criação Banco de Dados: CREATE DATABASE
    # 2. Criação de Tabelas: CREATE TABLE
    # 3. Adicionar valores nas tabelas: INSERT INTO
    # 4. Atualizar valores dentro da tabela: UPDATE
    # 5. Excluir valores de uma tabela: DELETE FROM
    # 6. Excluir tabelas: DROPE TABLE
    # 7. Excluit banco de dados: DROP DATABASE
